...
const main = async () => {
  ...
  if (loggedInAccountAddress === ownerAddress) {
    if (
      confirm(
        "Looks like you are the owner. Please sign in to view Owner features"
      )
    ) {
